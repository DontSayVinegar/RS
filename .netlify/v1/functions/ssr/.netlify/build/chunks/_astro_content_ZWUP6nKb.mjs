import { A as AstroError, R as RenderUndefinedEntryError, c as createComponent, u as unescapeHTML, b as renderTemplate, U as UnknownContentCollectionError, g as escape, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, r as renderComponent } from './astro/server__tdSHPvr.mjs';
import { a as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_LmcrUxcH.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_krvoUZFs.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BlXldOcX.mjs').then(n => n._);
